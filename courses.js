...
window.ICHEON_DATA = {
  ...
  COURSES: [
    { id: 'seolbong-story', name: '설봉공원 이야기·문화 코스', track: 'story', region: '도심·설봉권', rain: true,
      ...
      food: { q: '이천 설봉공원 근처 식당', list: [{ name: '푸주옥', tip: '아이와 함께 따끈한 설렁탕 한 그릇', q: '푸주옥 이천', placeId: '18460534', photo: 'food_pujuk' }, { name: '강민주의들밥 설봉점', tip: '반찬 셀프바가 있는 맛집 · 아이는 생선구이 추천', q: '강민주의들밥 설봉점', placeId: '1521633811' }, { name: '최고당돈가스 이천관고점', tip: '더블돈까스와 모밀 한 그릇으로 세 가족 배부른 식사', q: '최고당돈가스 이천관고점', placeId: '1745174700', photo: 'food_donkatsu' }] } },
