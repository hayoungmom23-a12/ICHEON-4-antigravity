...
window.ICHEON_DATA = {
  ...
  SPOTS: {
    seolbong: { name: '설봉공원', photo: 'seolbong', photos: ['seolbong', 'seolbong_spring', 'lake', 'seolbong_view'], recommended: true,
      ...
      facilities: [
        ...
        { name: '호수 산책', hours: '관광안내소 1주차장 또는 카페 옆 주차장에 대고 길 건너 진입', photo: 'lake', photos: ['lake', 'seolbong_spring', 'seolbong'] }
      ],
    ...
    farmpark: { name: '이천농업테마공원', photo: 'farmpark', photos: ['farmpark', 'rice_fest', 'rice_food', 'farmpark_water'], recommended: true,
      ...
      facilities: [
        ...
        { name: '쌀문화전시관', hours: '4~10월 09:30~18:30 · 11~3월 09:30~17:00 · 월요일 휴관', official: 'https://farmpark.2000fmc.or.kr/park/program', btnLabel: '체험예약', photo: 'rice_fest', photos: ['rice_fest', 'farmpark'] },
        { name: '유아숲놀이터', hours: '09:30~18:30 · 월요일 휴관 · 031-632-6607', photo: 'farmpark_forest', photos: ['farmpark_forest', 'farmpark_water'] },
    ...
    wood: { name: '이천목재문화체험장', photo: 'wood', photos: ['wood', 'woodcraft', 'woodcarving', 'wood_parking'],
      parkings: [{ name: '체험장 주차장', walkTo: '체험동', entry: '주차장에서 바로 앞 체험장으로 진입', q: '이천목재문화체험장', mapBased: false, photo: 'wood_parking', photos: ['wood_parking', 'wood'] }],
      facilities: [{ name: '목재 만들기 체험', hours: '체험 10:00 / 14:00 · 관람 09:00~18:00 · 화~일 운영 (월요일·둘째·넷째 일요일·설·추석 연휴·국경일 휴관)', official: 'https://www.2000forest.or.kr/facil/facil.php?sp=use', photo: 'woodcraft', photos: ['woodcraft', 'woodcarving'] }],
  ...
  COURSES: [
    ...
    { id: 'south-make', name: '남부 만들기 코스', track: 'make', region: '남부·모가권', rain: false,
      ...
      food: { q: '이천목재문화체험장 근처 식당', list: [{ name: '미솥지음 이천', tip: '임금님표 이천 쌀로 지은 솥밥과 맛 좋은 메뉴', q: '미솥지음 이천', placeId: '1920574397' }, { name: '남이천가정식부페', tip: '집밥 스타일 반찬을 아이가 직접 골라 담는 가정식 뷔페 · 가성비 최고', q: '남이천가정식부페', placeId: '19077544' }] } },
    { id: 'south-story', name: '남부 이야기·문화 코스', track: 'story', region: '남부·모가권', rain: false,
      ...
      food: { q: '이천농업테마공원 근처 식당', list: [{ name: '미솥지음 이천', tip: '임금님표 이천 쌀로 지은 솥밥과 맛 좋은 메뉴', q: '미솥지음 이천', placeId: '1920574397' }, { name: '남이천가정식부페', tip: '집밥 스타일 반찬을 아이가 직접 골라 담는 가정식 뷔페 · 가성비 최고', q: '남이천가정식부페', placeId: '19077544' }] } },
    { id: 'west-outdoor', name: '서이천 야외 활동 코스', track: 'out', region: '서이천·마장권', rain: false,
      ...
      food: { q: '덕평공룡수목원 근처 식당', list: [{ name: '덕평공룡수목원 디노레스토랑', tip: '수목원 입구의 레스토랑', q: '덕평공룡수목원 디노레스토랑', placeId: '1148934352' }, { name: '산타의돌짜장', tip: '뜨거운 돌판 짜장 · 아이들 최애 · 가성비', q: '산타의돌짜장 이천', placeId: '1202351897' }] } }
  ]
};
